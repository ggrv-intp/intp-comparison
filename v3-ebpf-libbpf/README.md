...
- V1.1: SystemTap + userspace helper (`v1.1-stap-helper/intp-helper`)
...
```text
# v3 ebpf-core -- netp:tracepoint nets:kprobe blk:tracepoint cpu:sched_switch llcmr:perf_event mbw:resctrl llcocc:resctrl
